		...
		$.extend(Timepicker.prototype, {
			...
			_newInst: function ($input, opts) {
				...
				overrides = {
					beforeShow: function (a, b) {
						return $.isFunction(tp_inst._defaults.evnts.beforeShow)
							? tp_inst._defaults.evnts.beforeShow.call($input[0], a, b, tp_inst)
							: void 0;
					},
					onChangeMonthYear: function (a, b, c) {
						$.isFunction(tp_inst._defaults.evnts.onChangeMonthYear) &&
							tp_inst._defaults.evnts.onChangeMonthYear.call($input[0], a, b, c, tp_inst);
					},
				...
				var timezoneList = [
					...
					0, 60, 120, 180, 210, 240, 270, 300, 330, 345, 360, 390, 420, 480, 525, 540, 570, 600,
					630, 660, 690, 720, 765, 780, 840,
				];
				...
				return (
					...
					(0 === tp_inst._defaults.minDate || 0 === tp_inst._defaults.minDateTime) &&
						(tp_inst._defaults.minDate = new Date()),
					(0 === tp_inst._defaults.maxDate || 0 === tp_inst._defaults.maxDateTime) &&
				...
				if (0 === a.find("div.ui-timepicker-div").length && b.showTimepicker) {
					var l = " ui_tpicker_unit_hide",
						m =
							...
							(b.oneLine && "select" === b.controlType ? " ui-timepicker-oneLine" : "") +
					...
					for (j = 0, k = this.units.length; k > j; j++) {
						if (
							...
							if (
								((m += '<div style="padding-left: 1px"><table class="ui-tpicker-grid-label"><tr>'),
								"hour" === d)
							)
					...
					if (
						...
						"undefined" != typeof this.hour && null !== this.hour && "" !== this.hour
					...
					if (
						...
						this.$timeObj.change(function () {
							...
							b
								...
								: ((this.value = c.formattedTime), this.blur());
						}),
						null !== this.inst)
					) {
				...
				if (this._defaults.showTimepicker) {
					...
					var j = g[12 > a ? "amNames" : "pmNames"][0],
						k =
							...
							(this.ampm.length > 0 &&
								12 > a != (-1 !== $.inArray(this.ampm.toUpperCase(), this.amNames))) ||
			...
			_updateDateTime: function (a) {
				...
				if (
					...
					this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !1
						? (g = this.formattedTime)
						: ((this._defaults.timeOnly !== !0 && (this._defaults.alwaysSetTime || f)) ||
								(this._defaults.timeOnly === !0 && this._defaults.timeOnlyShowDate === !0)) &&
						  (g += this._defaults.separator + this.formattedTime + this._defaults.timeSuffix),
					...
					if (
						...
						this._defaults.timeOnly ||
							((h = this._defaults.altFormat
								? $.datepicker.formatDate(this._defaults.altFormat, null === c ? new Date() : c, e)
								: this.formattedDate),
							h && (h += i)),
							(h +=
								null !== this._defaults.altTimeFormat
									? $.datepicker.formatTime(this._defaults.altTimeFormat, this, this._defaults) + j
			...
			$.fn.extend({
				...
				datetimepicker: function (a) {
					...
					return "string" == typeof a
						? "getDate" === a || ("option" === a && 2 === b.length && "string" == typeof b[1])
						...
						function (a, b, c) {
							var d,
								...
								g =
									...
									a
										.toString()
										.replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function (a) {
											var b = a.length;
							...
							return d
								? (-1 !== h.t &&
								  ...
								  -1 !== h.z &&
										void 0 !== d[h.z] &&
										(j.timezone = $.timepicker.timezoneOffsetNumber(d[h.z])),
								  j)
								: !1;
						}),
					f = function (a, b, c) {
						try {
							...
							if (
								...
								isNaN(d.getTime()) && ((d = new Date("01/01/2012 " + b)), isNaN(d.getTime())))
							)
			...
			($.datepicker._selectDate = function (a, b) {
				...
				e && d.settings.showTimepicker
					? (e._limitMinMaxDateTime(d, !0),
					  (c = d.inline),
					...
					if (c) {
						...
						(f += $.datepicker.formatTime(i, b, b._defaults) + h),
							b._defaults.timeOnly ||
								...
								null === d ||
								(f = b._defaults.altFormat
									? $.datepicker.formatDate(b._defaults.altFormat, d, e) + g + f
									: b.formattedDate + g + f),
							$(c).val(a.input.val() ? f : "");
					}
					...
					if (e) {
						...
						b &&
							("string" == typeof b
								...
								: ((f = new Date(b.getTime())), f.setMicroseconds(b.getMicroseconds())),
			...
			($.datepicker._setDateDatepicker = function (a, b) {
				...
				if (c) {
					...
					d instanceof Date
						? ((e = new Date(d.getTime())), e.setMicroseconds(d.getMicroseconds()))
						: (e = d),
						f &&
							e &&
							(f.support.timezone ||
								null !== f._defaults.timezone ||
								(f.timezone = -1 * e.getTimezoneOffset()),
							...
							e &&
								...
								null != d.timezone &&
									(d.support.timezone ||
										...
										(d.timezone = -1 * e.getTimezoneOffset()),
									(e = $.timepicker.timezoneAdjust(
										e,
										d.timezone,
										$.timepicker.timezoneOffsetString(-e.getTimezoneOffset())
			...
			($.datepicker._optionDatepicker = function (a, b, c) {
					...
					if (
						(k
							? ((k = 0 === k ? new Date() : new Date(k)),
							  ...
							  (f._defaults.minDateTime = k))
							: l
							? ((l = 0 === l ? new Date() : new Date(l)),
							  (f._defaults.maxDate = l),
							  (f._defaults.maxDateTime = l))
							: m && (f._defaults.onSelect = m),
						k || l)
					)
						return (
							(j = $(a)),
				...
				return void 0 === c
					...
					: this._base_optionDatepicker.call($.datepicker, a, d || b, c);
			});
		var isEmptyObject = function (a) {
			...
			splitDateTime = function (a, b) {
				var c = computeEffectiveSetting(b, "separator"),
					...
					h = g.length;
				return h > 1
					? { dateString: g.splice(0, h - f).join(c), timeString: g.splice(0, f).join(c) }
			...
			($.timepicker.handleRange = function (a, b, c, d) {
				...
				function f(b, c, e) {
					if (b.val()) {
						...
						null !== f &&
							d.minInterval > 0 &&
							("minDate" === e && f.setMilliseconds(f.getMilliseconds() + d.minInterval),
				...
				var g = !1;
				return (
					"timepicker" === a && ((g = !0), (a = "datetimepicker")),
					$.fn[a].call(
						b,
						$.extend(
							{
