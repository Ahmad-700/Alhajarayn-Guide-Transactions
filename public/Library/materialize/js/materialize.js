            ...
            register: function () {
              ...
              if (d)
                for (r in S.Hooks.templates) {
                  ...
                  "Color" === n[0] &&
                    (n.push(n.shift()), o.push(o.shift()), (S.Hooks.templates[r] = [n.join(" "), o.join(" ")]));
                }
              for (r in S.Hooks.templates) {
                (a = S.Hooks.templates[r]), (n = a[0].split(" "));
                for (var e in n) {
                  ...
                  case "extract":
                    ...
                    return (
                      S.RegEx.wrappedValueAlreadyExtracted.test(r)
                        ? (a = r)
                        : ((a = r.toString().match(S.RegEx.valueUnwrap)), (a = a ? a[1].replace(/,(\s+)?/g, " ") : r)),
                      a
                    );
                  case "inject":
                    return "rect(" + r + ")";
        ...
        var P = function () {
            ...
            function e(e) {
              function p(e, t) {
                ...
                return (
                  m.isArray(e)
                    ? ((r = e[0]),
                      (!m.isArray(e[1]) && /^[\d-]/.test(e[1])) || m.isFunction(e[1]) || S.RegEx.isHex.test(e[1])
                        ? (i = e[1])
              ...
              function h() {
                ...
                return (
                  ...
                  null === L.vwToPx &&
                    ((L.vwToPx = parseFloat(t.innerWidth) / 100), (L.vhToPx = parseFloat(t.innerHeight) / 100)),
                  (l.remToPx = L.remToPx),
                  (l.vwToPx = L.vwToPx),
                  (l.vhToPx = L.vhToPx),
                  ...
                  if (
                    ...
                    ((s.display !== a && null !== s.display && "none" !== s.display) ||
                      ...
                      s._cacheValues && E && E[z]
                        ? (M === a && (M = E[z].endValue + E[z].unitType), (B = i(o).rootPropertyValueCache[I]))
                    ...
                    if (
                      ...
                      if (0 === q) G = Y;
                        ...
                        n = n || h();
                        var Q =
                          /margin|padding|left|right|width|text|word|letter/i.test(z) || /X$/.test(z) || "x" === z
                            ? "x"
                            : "y";
                        switch (Y) {
                          case "%":
              ...
              parseFloat(s.delay) &&
                ...
                f.queue(o, s.queue, function (e) {
                  (b.velocityQueueEntryFlag = !0),
                    (i(o).delayTimer = { setTimeout: setTimeout(e, parseFloat(s.delay)), next: e });
                }),
          ...
          if (
            (m.isWrapped(this)
              ...
              : ((s = !0), (d = 1), (g = x ? arguments[0].elements || arguments[0].e : arguments[0])),
            (g = o(g)))
          ) {
            x
                    ...
                    return (
                      ...
                      f.each(g, function (e, t) {
                        parseFloat(j.stagger)
                          ...
                          j.drag &&
                            ((j.duration = parseFloat(E) || (/^(callout|transition)/.test(y) ? 1e3 : h)),
                            (j.duration = Math.max(
        ...
        return (
          ...
          f.each(["Down", "Up"], function (e, t) {
            b.Redirects["slide" + t] = function (e, r, n, o, i, s) {
              ...
              l.display === a &&
                (l.display =
                  "Down" === t ? ("inline" === b.CSS.Values.getDisplayType(e) ? "inline-block" : "block") : "none"),
                (l.begin = function () {
                  u && u.call(i, i);
                  for (var r in p) {
                    d[r] = e.style[r];
...
!(function (a, b, c, d) {
    ...
    handler: function (a) {
      ...
      b & O && 0 === a.button && (this.pressed = !0),
        ...
        this.pressed &&
          this.allow &&
          (b & Q && (this.pressed = !1),
          this.callback(this.manager, b, { pointers: [a], changedPointers: [a], pointerType: L, srcEvent: a }));
    },
  });
    ...
    handler: function (a) {
      ...
      if ((b === O && (this.started = !0), this.started)) {
        ...
        b & (Q | R) && 0 === c[0].length - c[1].length && (this.started = !1),
          this.callback(this.manager, b, { pointers: c[0], changedPointers: c[1], pointerType: J, srcEvent: a });
      }
    },
  });
  ...
  (Yb.prototype = {
    ...
    p(bc, ac, {
        ...
        return (
          e & b.direction ||
            (b.direction & X
              ...
              : ((e = 0 === g ? S : 0 > g ? V : W), (c = g != this.pY), (d = Math.abs(a.deltaY)))),
          (a.direction = e),
      ...
      attrTest: function (a) {
        return (
          ac.prototype.attrTest.call(this, a) && (this.state & Sb || (!(this.state & Sb) && this.directionTest(a)))
        );
      },
      emit: function (a) {
    ...
    p(cc, ac, {
      ...
      attrTest: function (a) {
        return (
          this._super.attrTest.call(this, a) && (Math.abs(a.scale - 1) > this.options.threshold || this.state & Sb)
        );
      },
      emit: function (a) {
    ...
    p(fc, ac, {
      defaults: { event: "swipe", threshold: 10, velocity: 0.65, direction: X | Y, pointers: 1 },
      getTouchAction: function () {
      ...
      attrTest: function (a) {
        ...
        return (
          b & (X | Y) ? (c = a.velocity) : b & X ? (c = a.velocityX) : b & Y && (c = a.velocityY),
      ...
      origin.on({
        "mouseenter.tooltip": function (e) {
          var showTooltip = function () {
            ...
            tooltipEl
              .velocity(
                { translateY: tooltipVerticalMovement, translateX: tooltipHorizontalMovement },
...
(function ($) {
  ...
  function onScroll(scrollOffset) {
    ...
    var intersections = findElements(
      top + offset.top + scrollOffset || 200,
      right + offset.right,
...
(function ($) {
  $(document).ready(function () {
    ...
    var showRangeBubble = function (thumb) {
      ...
      thumb.velocity(
        { height: "30px", width: "30px", top: "-30px", marginLeft: marginLeft },
                  ...
                  if (data.hasOwnProperty(key) && key.toLowerCase().indexOf(val) !== -1) {
                    ...
                    if (!!data[key]) {
                      autocompleteOption.append(
                        '<img src="' + data[key] + '" class="right circle"><span>' + key + "</span>"
                      );
                    } else {
      ...
      return this.each(function () {
        ...
        function moveToSlide(index) {
          ...
          if ($active_index != index) {
            ...
            $active.velocity(
              { opacity: 0 },
              {
                ...
                complete: function () {
                  $slides
                    .not(".active")
                    .velocity({ opacity: 0, translateX: 0, translateY: 0 }, { duration: 0, queue: false });
                },
              }
            );
            ...
            $slides
              .eq(index)
              .velocity({ opacity: 1 }, { duration: options.transition, queue: false, easing: "easeOutQuad" });
            $slides
              .eq(index)
              .find(".caption")
              .velocity(
        ...
        get: function (thing, format) {
          ...
          if (thing in P.component.item) {
            if (typeof format == "string") {
              ...
              return thingValue
                ? PickerConstructor._.trigger(P.component.formats.toString, P.component, [format, thingValue])
                : "";
            }
                ...
                _.node(
                  ...
                  _.group({
                    ...
                    item: function (rowCounter) {
                      ...
                      var shiftDateBy =
                        settings.firstDay && calendar.create([viewsetObject.year, viewsetObject.month, 1]).day === 0
                          ? -7
                          : 0;
