...
(function (root, doc, factory) {
      ...
      isEmbeddedPage: function (url) {
        ...
        if (u.protocol !== "") {
          return (
            !this.isPath(u.hash) &&
            u.hash &&
            (u.hrefNoHash === this.documentUrl.hrefNoHash || (this.documentBaseDiffers && u.hrefNoHash === this.documentBase.hrefNoHash))
          );
        }
        return /^#/.test(u.href);
      },
  ...
  (function ($) {
    ...
    $.widget("mobile.loader", {
      ...
      hide: function () {
        ...
        this.window.unbind("scroll", this.fakeFixLoader).unbind("scroll", this.checkLoaderPosition);
      },
    });
  })(jQuery, this);
  ...
  (function ($, undefined) {
    ...
    $.mobile.gradeA = function () {
      return (
        (($.support.mediaquery && $.support.cssPseudoElement) || ($.mobile.browser.oldIE && $.mobile.browser.oldIE >= 8)) &&
    ...
    $.widget("mobile.pagecontainer", {
      ...
      load: function (url, options) {
        ...
        var deferred = (options && options.deferred) || $.Deferred(),
          ...
          reloadOptionExtension = options && options.reload === undefined && options.reloadPage !== undefined ? { reload: options.reloadPage } : {},
    ...
    $.mobile._registerInternalEvents = function () {
      ...
      $.mobile.document.bind("vclick", function (event) {
        ...
        if ($.data(target, "mobile-button")) {
          ...
          if (!target || (path.parseUrl(target.getAttribute("href") || "#").hash === "#" && target.getAttribute("data-" + $.mobile.ns + "rel") !== "back")) {
            return;
          }
    ...
    $.widget("mobile.collapsible", {
      ...
      _create: function () {
        var elem = this.element,
          ui = {
            accordion: elem
              .closest(":jqmData(role='collapsible-set')," + ":jqmData(role='collapsibleset')" + ($.mobile.collapsibleset ? ", :mobile-collapsibleset" : ""))
      ...
      _enhance: function (elem, ui) {
        ...
        (ui.originalHeading = elem.children(this.options.heading).first()),
          (ui.content = elem.wrapInner("<div " + "class='ui-collapsible-content " + contentThemeClass + "'></div>").children(".ui-collapsible-content")),
      ...
      _applyOptions: function (options) {
        ...
        if (!(opts.iconpos === undefined && opts.collapsedIcon === undefined && opts.expandedIcon === undefined)) {
          ...
          if (hasIcon) {
            anchor.addClass(
              [iconposClass(opts.iconpos !== undefined ? opts.iconpos : currentOpts.iconpos)]
                .concat(
                  isCollapsed
                    ? ["ui-icon-" + (opts.collapsedIcon !== undefined ? opts.collapsedIcon : currentOpts.collapsedIcon)]
                    : ["ui-icon-" + (opts.expandedIcon !== undefined ? opts.expandedIcon : currentOpts.expandedIcon)]
                )
                .join(" ")
            );
          }
      ...
      $.extend(
        {
          ...
          _create: function () {
            ...
            if (!opts.enhanced) {
              elem.addClass(
                "ui-collapsible-set " + this._themeClassFromOption("ui-group-theme-", opts.theme) + " " + (opts.corners && opts.inset ? "ui-corner-all " : "")
              );
          ...
          _destroy: function () {
            ...
            el.removeClass("ui-collapsible-set ui-corner-all " + this._themeClassFromOption("ui-group-theme-", this.options.theme))
      ...
      $.extend(
        {
          ...
          _addThumbClasses: function (containers) {
            ...
            for (i = 0; i < len; i++) {
              ...
              if (img.length) {
                $(this._findFirstElementByTagName(img[0].parentNode, "parentNode", "li", "LI")).addClass(
                  img.hasClass("ui-li-icon") ? "ui-li-has-icon" : "ui-li-has-thumb"
                );
              }
            }
          },
      ...
      $.extend(
        {
          ...
          _wrapper: function () {
            return $("<div class='ui-" + this.inputtype + (this.options.disabled ? " ui-state-disabled" : "") + "' ></div>");
          },
  ...
  (function ($, undefined) {
    $.widget("mobile.button", {
      ...
      _setOptions: function (options) {
        ...
        if (options.icon !== undefined || options.iconshadow !== undefined /* TODO: Deprecated in 1.4, remove in 1.5. */ || options.iconpos !== undefined) {
      ...
      $.extend(
        {
          ...
          _create: function () {
            ...
            if (!isToggleSwitch && !isRangeslider) {
              wrapper = "<div class='ui-slider" + (this.options.mini ? " ui-mini" : "") + "'></div>";
  ...
  (function ($, undefined) {
    $.widget("mobile.textinput", $.mobile.textinput, {
      ...
      clearButton: function () {
        return $("<a href='#' tabindex='-1' aria-hidden='true' " + "class='ui-input-clear ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all'>" + "</a>")
            ...
            var options = this.options,
              ...
              button = this.button
                ...
                .addClass(
                  "ui-btn" +
                    (options.icon
                      ? " ui-icon-" + options.icon + " ui-btn-icon-" + iconpos + (options.iconshadow ? " ui-shadow-icon" : "")
                      : "") /* TODO: Remove in 1.5. */ +
                    (options.theme ? " ui-btn-" + options.theme : "") +
                    (options.corners ? " ui-corner-all" : "") +
                    (options.shadow ? " ui-shadow" : "")
  ...
  (function ($, undefined) {
    ...
    $.widget("mobile.popup", {
      ...
      _openPrerequisitesComplete: function () {
        ...
        this._ignoreResizeEvents();
        if (id) {
          this.document.find("[aria-haspopup='true'][aria-owns='" + $.mobile.path.hashToSelector(id) + "']").attr("aria-expanded", true);
        }
      ...
      _closePrerequisitesDone: function () {
        ...
        if (id) {
          this.document.find("[aria-haspopup='true'][aria-owns='" + $.mobile.path.hashToSelector(id) + "']").attr("aria-expanded", false);
        }
      ...
      _closePopup: function (theEvent, data) {
        ...
        if (theEvent && theEvent.type === "pagebeforechange" && data) {
          ...
          if (this._myUrl !== $.mobile.path.makeUrlAbsolute(toUrl) || data.options.reloadPage) {
  ...
  (function ($, undefined) {
    ...
    $.widget("mobile.selectmenu", $.mobile.selectmenu, {
      ...
      _handleListFocus: function (e) {
        var params = e.type === "focusin" ? { tabindex: "0", event: "vmouseover" } : { tabindex: "-1", event: "vmouseout" };
      ...
      build: function () {
        ...
        dividerThemeAttr =
          o.dividerTheme && this.element.children("optgroup").length > 0 ? " data-" + $.mobile.ns + "divider-theme='" + o.dividerTheme + "'" : "";
        menuPage = $(
          "<div data-" +
            $.mobile.ns +
            "role='dialog' class='ui-selectmenu'" +
            themeAttr +
            overlayThemeAttr +
            ">" +
            "<div data-" +
        ...
        listbox = $("<div" + themeAttr + overlayThemeAttr + " class='ui-selectmenu'></div>")
          .attr("id", popupId)
          .insertAfter(this.select)
          .popup();
        list = $("<ul class='ui-selectmenu-list' role='listbox' aria-labelledby='" + this.buttonId + "'" + themeAttr + dividerThemeAttr + "></ul>")
          .attr("id", menuId)
          .appendTo(listbox);
      ...
      $.extend(
        {
            ...
            var elem = this.element,
              ...
              ui = {
                ...
                childWrapper: elem
                  ...
                  .wrapInner("<div " + "class='ui-controlgroup-controls " + (opts.shadow === true ? "ui-shadow" : "") + "'></div>")
                  .children(),
              };
          ...
          _destroy: function () {
            ...
            buttons = this.element
              .removeClass(
                "ui-controlgroup " + "ui-controlgroup-horizontal ui-controlgroup-vertical ui-corner-all ui-mini " + this._themeClassFromOption(opts.theme)
              )
              .find(".ui-btn")
      ...
      $.widget("mobile.toolbar", $.mobile.toolbar, {
        ...
        _handlePageFocusinFocusout: function (event) {
          ...
          if (
            ...
            !$(event.target).closest(".ui-header-fixed, .ui-footer-fixed").length
          ) {
      ...
      close: function (immediate) {
        if (this._open) {
          var self = this,
            ...
            complete = function () {
              if (o.theme && o.display !== "overlay") {
                currentPage.parent().removeClass(o.classes.pageContainer + "-themed " + o.classes.pageContainer + "-" + o.theme);
              }
          ...
          if (priority) {
            ...
            input = (
              keep
                ...
                : $("<label><input type='checkbox' checked />" + (header.children("abbr").first().attr("title") || header.text()) + "</label>")
                    .appendTo(container)
                    .children(0)
                    .checkboxradio({
      ...
      _setInput: function (selector) {
        ...
        if (!selector) {
          if (this._isSearchInternal()) {
            ...
            selector = $("<input " + "data-" + $.mobile.ns + "type='search' " + "placeholder='" + opts.filterPlaceholder + "'></input>").jqmData(
  ...
  (function ($, undefined) {
    $.widget("mobile.pagecontainer", $.mobile.pagecontainer, {
      ...
      _performTransition: function (transition, reverse, to, from) {
        ...
        return new TransitionHandler(transition, reverse, to, from).transition($.mobile.navigate.history.getActive().lastScroll || $.mobile.defaultHomeScroll);
      },
    });
  })(jQuery);
